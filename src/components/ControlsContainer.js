...
const ControlsContainer = ({
  length,
  current,
  changeCurrentUpwards,
  changeCurrentDownwards,
}) => {
  const classes = useStyles();
  return (
    <>
      <div className={classes.container}>
        <Typography className={classes.positionText} color="textPrimary">
          {current + 1} of {length}
        </Typography>
        <div
        ...
        <div className={classes.positionControl} onClick={changeCurrentUpwards}>
