        ...
        >
          ...
          <Grid container className={classes.rootContainer}>
            <Grid item lg={4} className={classes.stickyLeft}>
              <img src={Me} alt="me" className={classes.profileImage} />
            </Grid>
            <Grid
              item
              lg={7}
            ...
            >
              ...
              <ScreenContainer>
                ...
                <Typist className={classes.typingAnimation} startDelay={1000}>
                ...
                <Typography variant="body1" className={classes.bodyText}>
                  Hi! I am a professional software developer based in Nairobi,
                  Kenya. I am experienced in creating scalable software
                  solutions that meet my clients' needs. I love working with
                  teams and picking up on new tech and trends!
                </Typography>
                <Button
                  variant="outlined"
              ...
              <ScreenContainer>
                ...
                <Typography variant="body1" className={classes.bodyText}>
                  I am just another guy who fell for coding. I started writing
                  HTML code in my freshman year of campus and loved it
                  instantly. Since then, I have been discovering more of the
                  beauty of building software every day.
                </Typography>
                <Typography variant="body1" className={classes.bodyText}>
                  Besides coding, I enjoy playing chess and solving the
                  best-selling puzzle in the world, Erno Rubik’s cube. I have a
                  decent sense of humour, I believe.
                </Typography>
                <Typography variant="body1" className={classes.bodyText}>
